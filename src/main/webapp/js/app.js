...
function initMatchScorePage() {
    ...
    function renderMatch(match) {
        ...
        $('.point-btn').first().data('player-name', match.firstPlayerName);
        $('.point-btn').last().data('player-name', match.secondPlayerName);
